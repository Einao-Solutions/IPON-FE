<script lang="ts">
	...
	const stepIcons: Record<string, string> = {
		'Design Information': 'heroicons:information-circle',
		'Applicants Information': 'heroicons:user-group',
		'Creators Information': 'heroicons:user',
		'Priority Information': 'heroicons:document-text',
...
{#if showCancelConfirm}
	<div class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
		<div class="bg-white p-6 rounded-lg shadow-lg max-w-sm w-full">
			<h2 class="text-lg font-bold mb-4">Exit Design Application?</h2>
