								...
								<div class="border rounded-lg p-3 bg-gray-50 hover:bg-gray-100 transition-colors {selectedAttachmentIndices.includes(index) ? 'border-blue-500 bg-blue-50' : ''}">
									<div class="flex items-center gap-3">
										...
										<div class="flex-shrink-0">
											{#if attachment.url}
												<a href={attachment.url} target="_blank" rel="noopener" class="bg-green-600 hover:bg-green-700 text-white px-3 py-2 rounded-lg text-sm font-medium transition-colors inline-flex items-center gap-2 shadow-sm whitespace-nowrap" on:click={(e) => e.stopPropagation()}><Icon icon="mdi:file-eye" width="1.2em" height="1.2em" /><span>View</span></a>
