<script lang="ts">
	...
	let newMortgagorData: NewMortgagorData = {
		name: '',
		email: '',
		phone: '',
		nationality: '',
	...
	function validateForm(): boolean {
		...
		if (!newMortgagorData.name.trim()) {
			error = 'Please enter new mortgagor name.';
			return false;
		}

		if (!newMortgagorData.email.trim()) {
			error = 'Please enter new mortgagor email.';
			return false;
		}

		if (!newMortgagorData.phone.trim()) {
			error = 'Please enter new mortgagor phone number.';
			return false;
		}

		if (!newMortgagorData.nationality.trim()) {
			error = 'Please select new mortgagor nationality.';
			return false;
		}
		...
		if (!newMortgagorData.state.trim()) {
			error = 'Please enter new mortgagor state.';
			return false;
		}
	...
	async function handleSubmit() {
		...
		try {
			...
			const payload = {
				...
				// Old mortgagee (current patent holder)
				oldMortgageeName: applicantName,
				oldMortgageeEmail: applicantEmail,
				...
				newMortgagorEmail: newMortgagorData.email,
...
<div class="min-h-screen py-4 px-4">
	<div class="w-full mx-auto">
		...
		<div class="px-6 py-6">
			...
			<!-- Old Mortgagee Information Section -->
			<div class="mb-6 border border-gray-300 rounded-md overflow-hidden">
			...
			<div class="mb-6 border border-gray-300 rounded-md overflow-hidden">
				...
				<div class="p-4 grid grid-cols-1 md:grid-cols-2 gap-4">
					<div>
						...
						<input
							type="text"
							bind:value={newMortgagorData.name}
							class="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-green-500 focus:border-green-500"
							placeholder="Enter new mortgagor name"
							required
						/>
					</div>
					...
					<div>
						...
						<input
							type="email"
							bind:value={newMortgagorData.email}
							class="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-green-500 focus:border-green-500"
							placeholder="Enter new mortgagor email"
							required
						/>
					</div>
					...
					<div>
						...
						<input
							type="tel"
							bind:value={newMortgagorData.phone}
							class="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-green-500 focus:border-green-500"
							placeholder="Enter new mortgagor phone number"
							required
						/>
					</div>
					...
					<div>
						...
						<select
							bind:value={newMortgagorData.nationality}
							class="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-green-500 focus:border-green-500"
							required
						>
					...
					<div>
						...
						<input
							type="text"
							bind:value={newMortgagorData.state}
							class="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-green-500 focus:border-green-500"
							placeholder="Enter new mortgagor state"
							required
						/>
					</div>
					...
					<div class="md:col-span-2">
						...
						<textarea
							bind:value={newMortgagorData.address}
							class="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-green-500 focus:border-green-500"
							placeholder="Enter new mortgagor full address"
							rows="3"
							required
						></textarea>
					</div>
