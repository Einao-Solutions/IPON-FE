                ...
                >
                  ...
                  {#if result.fileTypes === FileTypes.Trademark}
                    ...
                    <option value="update-title"
                      >Update Title/Representation</option
                    >
                    <option value="update-class"
                      >Update Class/Description/Disclaimer</option
                    >
                  ...
                  {:else if result.fileTypes === FileTypes.Design}
                    ...
                    >
                    <option value="creator-info"
                      >Update Creator Information</option
                    >
                    <option value="correspondence"
                      >Update Correspondence Information</option
                    >
