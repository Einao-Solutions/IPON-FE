<script lang="ts">
  ...
  $: formTitle =
    fileInfo.updateType !== null
      ? getFormTitle(fileInfo.updateType)
      : "Application for Clerical Update";
  ...
  function validateForm(): boolean {
    if (showNameSection) {
      if (
        !newData.applicantNames ||
        newData.applicantNames.some((n) => !n.trim())
      ) {
    ...
    try {
      ...
      if (updateType === ClericalUpdateTypes.ApplicantName) {
        ...
        if (fileInfo.fileType === 0) {
          formObj.OldApplicantNames =
            fileInfo.applicants?.map((a) => a.name) ?? [];
        } else {
  ...
  function getPatentApplicationTypeLabel(
    type: PatentApplicationTypes | null,
  ): string {
    switch (type) {
  ...
  $: isReadyForPayment =
    ...
    fileInfo.fileStatus !== ApplicationStatuses.Withdrawn;
  $: isPriorityInfoNotAllowed =
    updateType === ClericalUpdateTypes.PriorityInfo &&
    patentTypeValue !== null &&
    fileInfo.patentType === 1;
</script>
  ...
  <div class="w-full mx-auto">
    ...
    <div class="px-6 py-6">
          ...
          <div class="flex items-center justify-center p-12">
            <div class="flex flex-col items-center gap-2">
              ...
              <span class="text-sm text-gray-500"
                >Loading Patent Information...</span
              >
            </div>
          </div>
        {:else}
          <div class="p-4">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div>
                ...
                <input
                  ...
                  placeholder={fileInfo.fileOrigin}
                  class="w-full px-3 py-2 border border-gray-300 rounded-md bg-gray-100"
                  disabled
                />
              </div>
              <div>
                ...
                <input
                  ...
                  placeholder={getPatentTypeLabel(fileInfo.patentType)}
                  class="w-full px-3 py-2 border border-gray-300 rounded-md bg-gray-100"
                  disabled
                />
              </div>
              <div>
                ...
                <input
                  ...
                  type="text"
                  value={getPatentApplicationTypeLabel(
                    fileInfo.patentApplicationType,
                  )}
                  placeholder={getPatentApplicationTypeLabel(
                    fileInfo.patentApplicationType,
                  )}
                  class="w-full px-3 py-2 border border-gray-300 rounded-md bg-gray-100"
                  disabled
            ...
            <div class="mt-4">
              ...
              <textarea
                ...
                placeholder={fileInfo.patentAbstract}
                class="w-full px-3 py-2 border border-gray-300 rounded-md bg-gray-100"
                disabled
              ></textarea>
            </div>
                ...
                <div class="mt-2 grid grid-cols-1 gap-4">
                  ...
                  <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                      ...
                      <p class="text-xs text-gray-500 mt-1">
                        Current nationality: <b>{applicant.nationality}</b>
                      </p>
                    </div>
                  </div>
                  <!-- City alone -->
      ...
      {#if showTitleOfInventionSection}
        <div class="mb-6 border border-gray-300 rounded-md overflow-hidden">
          <div class="bg-yellow-300 px-4 py-2 font-medium text-yellow-900">
            NEW PATENT ABSTRACT
          </div>
          <div class="p-4">
        ...
        <div class="mb-6 border border-gray-300 rounded-md overflow-hidden">
          ...
          <div class="p-4 grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              ...
              />
              <p class="text-xs text-gray-500 mt-1">
                This will replace the current title of invention shown above.
              </p>
            </div>
            <div>
              <label
              ...
              >
                ...
                >
                <option value={PatentApplicationTypes.Utility_Model}
      ...
      {#if selectedRemoveIds.length > 0}
        <div class="mb-2 text-red-700 font-semibold">
          {selectedRemoveIds.length} applicant{selectedRemoveIds.length > 1
            ? "s"
      ...
      {#if showAddApplicantSection && fileInfo.applicants && fileInfo.applicants.length > 0}
        <div class="mb-6 border border-gray-300 rounded-md overflow-hidden">
          <div class="bg-gray-100 px-4 py-2 font-medium text-gray-900">
            EXISTING APPLICANTS
          </div>
          <div class="p-4">
            {#each fileInfo.applicants as applicant, i}
              ...
              >
                ...
                >
                  ...
                  <div>
                    <label
                      for={`applicant-${i}-address`}
                      class="block text-sm font-medium text-gray-700 mb-1"
                      >Address:</label
                    >
                    <input
                      id={`applicant-${i}-address`}
                      type="text"
                  ...
                  <div>
                    <label
                      for={`applicant-${i}-email`}
                      class="block text-sm font-medium text-gray-700 mb-1"
                      >Email:</label
                    >
                    <input
                      id={`applicant-${i}-email`}
                      type="text"
                  ...
                  <div>
                    <label
                      for={`applicant-${i}-phone`}
                      class="block text-sm font-medium text-gray-700 mb-1"
                      >Phone:</label
                    >
                    <input
                      id={`applicant-${i}-phone`}
                      type="text"
                  ...
                  <div>
                    <label
                      for={`applicant-${i}-nationality`}
                      class="block text-sm font-medium text-gray-700 mb-1"
                      >Nationality:</label
                    >
                    <input
                      id={`applicant-${i}-nationality`}
                      type="text"
                  ...
                  <div>
                    <label
                      for={`applicant-${i}-state`}
                      class="block text-sm font-medium text-gray-700 mb-1"
                      >State:</label
                    >
                    <input
                      id={`applicant-${i}-state`}
                      type="text"
      ...
      {#if showDeleteModal}
        ...
        >
          <div class="bg-white rounded-lg shadow-lg p-6 w-full max-w-md">
            ...
            <p class="mb-6">
              Are you sure you want to remove {selectedRemoveIds.length} applicant{selectedRemoveIds.length >
              1
                ? "s"
                : ""}?
            </p>
            <div class="flex justify-end gap-2">
              ...
              <button
                ...
                on:click={confirmDelete}>Yes, Remove</button
              >
            </div>
          </div>
        </div>
      ...
      {#if updateType === ClericalUpdateTypes.CorrespondenceInformation}
        <div class="mb-6 border border-gray-300 rounded-md overflow-hidden">
          <div class="bg-indigo-100 px-4 py-2 font-medium text-indigo-900">
            CORRESPONDENCE INFORMATION
          </div>
          <div class="p-4 grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              <label
                for="correspondenceName"
                class="block text-sm font-medium text-gray-700 mb-1"
            ...
            <div>
              <label
                for="correspondenceNationality"
                class="block text-sm font-medium text-gray-700 mb-1"
                >Correspondence Country</label
              >
              <input
                type="text"
