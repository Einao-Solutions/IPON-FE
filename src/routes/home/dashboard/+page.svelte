...
{:else}
  ...
  >
    <div class="absolute whitespace-nowrap animate-marquee top-1">
      ...
      <b>◆</b>
      You can now file Clerical Updates (Add/Remove Applicant, Edit/Add/Remove Inventor
      ...
      <b>◆</b>
      You can now file Recordals (Merger, Registered User, and Assignment) for Trademark
      applications with status 'Publication', 'Awaiting Certification, and Awaiting
      Certificate Confirmation'.
      <b>◆</b>
      You can now file Clerical Updates (Change of Name, Address, Representation,
      Correspondence, and Attachment, ) for trademark applications with status 'Publication'
      and 'AwaitingCertification'.
      <b>◆</b>
      You can now get your Trademark Recordal Certificates (Merger, Registered User,
      Assignment, Change of Applicant Name, and Change of Applicant Address) using
      the 'Print Documents' Module.
      <b>◆</b>
