	...
	>
		<div class="bg-white rounded-lg p-6 w-full max-w-md mx-4" on:click|stopPropagation>
			<div class="flex items-center justify-between mb-4">
				<div>
					<h3 id="modal-title" class="text-lg font-bold text-black">Claim File Search</h3>
					<p class="text-sm text-gray-600 mt-1">Please enter the File Number you want to search</p>
				</div>
				<button
					type="button"
