...
export const ticketStats = writable<Record<string, number>>({})
export const ipoTicketsSummary = writable<TicketSummary[]|null>(null)
export const ipoTicketStats = writable<Record<string, number>>({})
